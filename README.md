...
**Training Method:** QLoRA fine-tuning (4-bit NF4, rank 64, alpha 128) on NVIDIA A100, B200, and DGX Spark hardware
...
- [x] v3.0 - 13 models trained across 8 architectures on NVIDIA A100, B200, and DGX Spark
